...
Докозательство. Зафиксируем $x_1 \in X$ и обозначим через $E$ подмножество в $\mathbb {N}$, состоящее из всех натуральных чисел, для которых существует конечная последовательность $x_1,x_2, \dots ,x_n \in X$ со следующим свойством: 
...
Из определения сходимости последовательности $\{x_n\}$ следует, что последовательность сходится, если и только если существует бесконечно малая последовательность $\{x_n\}$.
...
### <a name="Parag13"></a> 13.формулируйте теорему о предельном переходе в неравенствах. Справедлива ли она для строгих неравенств?
...
для любого markdown как записать 
