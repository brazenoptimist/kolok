...
### <a name="Parag3"></a>  Дайте опредение модуля числа. Перечислите свойства модуля числа.
...
### <a name="Parag4"></a>  Дайте определение натурального числа. Сформулируйте теорему о доказательстве методом математичекой ндукции.
...
### <a name="Parag5"></a>  Сформулируйте теорему об определениях методом математической индукции. Привидите примеры определений по индукции.
...
### <a name="Parag6"></a>  Сформулируйте принцип Архимеда. Ограничено ли множество натуральных чисел?
